  ...
  return (
    <footer className="site-footer">
      <div className="footer-container">
        ...
        >
          <strong>Disclaimer:</strong> Project images and developer logos
          displayed on this website are used strictly for portfolio and
          reference purposes. All trademarks and brand names belong to their
          respective owners.
        </p>
      </div>
    </footer>
